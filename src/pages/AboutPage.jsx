...
export default function AboutPage() {
  ...
  return (
    <div className="about-main">
      ...
      <a href="https://github.com/blockdoyle/HealthApplication">
        Health Application Repo
      </a>
      <h1>Our Team</h1>
      <div className="about-cards">
        <a href="https://github.com/blockdoyle">
